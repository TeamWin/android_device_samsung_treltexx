...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_trelte_xx
...
TARGET_INIT_VENDOR_LIB := libinit_treltexx
TARGET_RECOVERY_DEVICE_MODULES := libinit_treltexx
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_treltexx.cpp
